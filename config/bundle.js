...
module.exports = function () {
  ...
  var bundler = new WebpackDevServer(compiler, {
    ...
    // We need to tell Webpack to serve our bundled application from the build path. When proxying:
  ...
  // We fire up the development server and give notice in the terminal that we are starting the initial bundle
